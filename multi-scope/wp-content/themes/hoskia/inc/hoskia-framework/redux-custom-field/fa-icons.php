...
// the opt_name is set to hoskia_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/hoskia_opt/enqueue', 'hoskia_faIconFont' );
function hoskia_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', HOSKIA_DIR_CSS_URI.'font-awesome.min.css', array(), '1.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'hoskia-redux-admin', HOSKIA_DIR_URI.'inc/hoskia-framework/redux-custom-field/assist/hoskia-redux-admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'hoskia-redux-admin', HOSKIA_DIR_URI.'inc/hoskia-framework/redux-custom-field/assist/hoskia-redux-admin.js', array( 'jquery' ), '1.0', true );
