...
add_action( 'admin_enqueue_scripts', 'bulkdomain_core_styles_scripts_admin' );
function bulkdomain_core_styles_scripts_admin(){
	
	// CMB2
	wp_enqueue_style( 'switch_metafield', plugins_url( 'css/switch_metafield.css', __FILE__ ) , array(), '1.0' );
	

	
	wp_enqueue_script( 'switch_metafield', plugins_url( 'js/switch_metafield.js', __FILE__ ) , array('jquery'), '1.0', true );
